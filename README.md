Dijital Menü Oluşturma ve Yönetim Sistemi

Bu proje, restoran, kafe, bar ve tüm yiyecek-içecek işletmelerinin kendi QR menülerini kolayca oluşturabilmesi, düzenleyebilmesi ve müşterilere sunabilmesi için geliştirilmiş bir web uygulamasıdır.
Tamamen PHP tabanlı olup veritabanı olarak MySQL kullanılmaktadır.
...
Müşteri/işletme yönetimi

Menü düzenleme

Abonelik / paket sistemi eklenebilir (opsiyonel)

✅ Modern, Hızlı ve Güvenilir
...
✔ Fiziksel menü bastırma maliyetini azaltmak
...
Tema renkleri değiştirilebilir

Ek dil desteği eklenebilir

Abonelik sistemi kolayca entegre edilebilir

İşletmeler için panel genişletilebilir
